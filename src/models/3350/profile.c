...
const ModelProfile model_3350 = {
    ...
    //. COBBA s/n 00335042, IMEI 490154203350014.
    .identity = {
        .msid   = { 0x83, 0x6B, 0x0A, 0xD4, 0x80, 0x0D, 0xDE, 0xAE, 0x4D, 0x01, 0xE3, 0x7B, 0xFC },
        .imei14 = "49015420335001",
    },
    .battery = {
