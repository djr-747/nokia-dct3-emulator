...
// Family B (3310-style) keypad matrix — the RE'd lines live in keylines_5110.h (shared
// with the 5130/5190 siblings). The 5110 ALSO has dedicated screen-side volume buttons
// (up/down on the left edge) that the candybar 3310 lacks — they sit on their own
