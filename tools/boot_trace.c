...
int main(int argc, char** argv) {
    ...
    // (SPIKE removed 2026-07-15: the historical FuBu v6.39 verdict-pin + SIM-gate
    // shorthand. Every image boots organically now — the DSP responder passes the
    // verdict and the SIM state machine advances disp49 itself. An explicit POKE
    // can still reproduce the old behaviour for RE.)
